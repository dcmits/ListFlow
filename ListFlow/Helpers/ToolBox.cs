...
namespace ListFlow.Helpers
{
    public static class ToolBox
    {
        ...
        /// <param name="includeStart">True include the start delimiter in the result.</param>
        /// <param name="includeEnd">True include the end delimiter in the result.</param>
        /// <returns>String between the two delimters or null if delimiter not found.</returns>
        public static string ExtractBetweenTwoStrings(string text, string start, string end, bool includeStart, bool includeEnd)
        {
            try
            {
                ...
                return (startIndex <= endIndex && endIndex > -1) ? string.Concat(includeStart ? start : string.Empty, text.Substring(startIndex, endIndex - startIndex), includeEnd ? end : string.Empty) : null;
            }
            catch
            {
                return null;
